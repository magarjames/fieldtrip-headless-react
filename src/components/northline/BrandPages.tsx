      ...
      <div className="shell py-24 md:py-32">
        <div
          ...
          style={{
            ...
            boxShadow: "0 24px 60px rgba(0,0,0,0.2), inset 0 1px 1px rgba(255, 255, 255, 0.6)",
          }}
        >
          {/* Glass Nav */}
          <nav
            className="flex flex-col sm:flex-row items-center justify-between p-6 md:px-10 md:py-6 border-b border-black/10 gap-6 sm:gap-0 sticky top-0 z-20"
            style={{ background: "rgba(255, 255, 255, 0.4)", backdropFilter: "blur(12px)" }}
          >
            <div className="text-[12px] font-bold tracking-[0.3em] uppercase text-black">
              Vivre—Club
            </div>
            <div className="flex border border-black/10 rounded-full overflow-hidden p-1 bg-black/5">
              {tabs.map((tab) => (
                <button
                  key={tab.id}
          ...
          {/* Content Area */}
          <div className="p-8 md:p-14 lg:p-20 text-black/80 text-[15px] leading-[1.65]">
            {activeTab === "about" && (
              <div className="animate-in fade-in duration-500">
                <p className="text-[9px] font-bold tracking-[0.35em] uppercase text-black/50 mb-5">
                  About VIVRE-CLUB
                </p>
                <h1 className="text-[clamp(28px,5vw,42px)] font-bold tracking-[-0.01em] leading-[1.1] mb-10 text-black">
                  Clothes built to be worn. Not collected.
                </h1>

                <p className="text-[17px] leading-[1.6] text-black mb-5">
                ...
                <div className="h-px bg-black/10 my-10"></div>

                <h2 className="text-[11px] font-bold tracking-[0.25em] uppercase mt-[52px] mb-4 pb-3 border-b border-black/10 text-black">
                  How it works
                </h2>
                <p className="mb-4">
                ...
                <div className="inline-block border border-black/20 px-4 py-2 mt-12 text-[9px] font-bold tracking-[0.25em] uppercase text-black/50 rounded-lg">
            ...
            {activeTab === "shipping" && (
              <div className="animate-in fade-in duration-500">
                ...
                <table className="w-full border-collapse my-5 text-[14px]">
                  <tbody>
                    <tr className="border-b border-black/10">
                      <td className="py-3.5 text-black/60 w-[44%] text-[13px] align-top">
                        Processing time
                      </td>
                      <td className="py-3.5 text-black font-medium align-top">1–3 business days</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      <td className="py-3.5 text-black/60 w-[44%] text-[13px] align-top">
                        Order confirmation
                      </td>
                      <td className="py-3.5 text-black font-medium align-top">
                        Emailed immediately
                      </td>
                    </tr>
                    <tr className="border-b border-black/10">
                ...
                <table className="w-full border-collapse my-5 text-[14px]">
                  <tbody>
                    ...
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3.5 text-black font-medium align-top">Orders over £80</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div className="border-l-2 border-black/30 p-5 my-8 bg-black/5 text-[13px] text-black/70 rounded-r-lg">
                ...
                <p className="mb-4">
                  ...
                  <strong className="text-black font-semibold">support@vivre-club.com</strong> with
            ...
            {activeTab === "returns" && (
              <div className="animate-in fade-in duration-500">
                ...
                <table className="w-full border-collapse my-5 text-[14px]">
                  <tbody>
                    ...
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3.5 text-black font-medium align-top">Paid by customer</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      <td className="py-3.5 text-black/60 w-[44%] text-[13px] align-top">
                        Refund method
                ...
                <p className="mb-4">
                  Email <strong className="text-black font-semibold">support@vivre-club.com</strong>{" "}
            ...
            {activeTab === "privacy" && (
              <div className="animate-in fade-in duration-500">
                ...
                <p className="mb-4">
                  <strong className="text-black font-semibold">Last updated:</strong> August 2026
                </p>
                ...
                <p className="mb-4">
                  <strong className="text-black font-semibold">Shopify</strong> — our store
                  platform, which processes payments and stores order data. Shopify is GDPR
                  compliant.
                </p>
                <p className="mb-4">
                  <strong className="text-black font-semibold">Shipping partners</strong> — your
                  name and address are shared with our logistics providers to fulfil delivery.
                </p>
                <p className="mb-4">
                  <strong className="text-black font-semibold">Marketing platforms</strong> — if you
                ...
                <p className="mb-4">
                  ...
                  <strong className="text-black font-semibold">support@vivre-club.com</strong>.
                </p>
