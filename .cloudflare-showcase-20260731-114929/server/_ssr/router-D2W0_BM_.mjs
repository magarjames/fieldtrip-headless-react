...
import { a as PIECES, o as TAGLINE, r as DROP, t as BRAND$2 } from "./data-pfKPmX5L.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-D2W0_BM_.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CTh3EHqe.css";
...
var $$splitComponentImporter$25 = () => import("./northline-world-Dpryh8Dn.mjs");
var Route$25 = createFileRoute("/northline-world")({
...
var $$splitComponentImporter$24 = () => import("./northline-DPwYFWfE.mjs");
var Route$24 = createFileRoute("/northline")({
...
var $$splitComponentImporter$23 = () => import("./editions-CGMLgTnX.mjs");
var Route$23 = createFileRoute("/editions")({
...
var $$splitComponentImporter$22 = () => import("./routes-DdFOYGDv.mjs");
var Route$22 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$22, "component") });
var $$splitComponentImporter$21 = () => import("./w.index-HQZChzAI.mjs");
var Route$21 = createFileRoute("/w/")({
...
var $$splitComponentImporter$20 = () => import("./s.index-C5tLKRST.mjs");
var Route$20 = createFileRoute("/s/")({
	component: lazyRouteComponent($$splitComponentImporter$20, "component"),
	head: () => pageMeta(`${BRAND$2} — ${DROP}`, `${TAGLINE}. 18 pieces, styled as fits.`)
});
var $$splitComponentImporter$19 = () => import("./nl.index-BBqSsO-F.mjs");
var Route$19 = createFileRoute("/nl/")({
...
var $$splitComponentImporter$18 = () => import("./w.weave-BdO35tVC.mjs");
var Route$18 = createFileRoute("/w/weave")({
	component: lazyRouteComponent($$splitComponentImporter$18, "component"),
	head: () => pageMeta(`${BRAND$1} — Weave`, `Six hundred instanced threads under tension, driven by scroll.`)
});
var $$splitComponentImporter$17 = () => import("./w.vitrine-BKwmBUNl.mjs");
var Route$17 = createFileRoute("/w/vitrine")({
	component: lazyRouteComponent($$splitComponentImporter$17, "component"),
	head: () => pageMeta(`${BRAND$1} — Vitrine`, `The ${SEASON.toLowerCase()} edition hung as plates in real 3D space.`)
});
var $$splitComponentImporter$16 = () => import("./w.tide-Bg0jxrl7.mjs");
var Route$16 = createFileRoute("/w/tide")({
	component: lazyRouteComponent($$splitComponentImporter$16, "component"),
	head: () => pageMeta(`${BRAND$1} — Tide`, `A live gradient horizon with the making sequence scrubbed across it.`)
});
var $$splitComponentImporter$15 = () => import("./w.kiln-DhpHDMrX.mjs");
var Route$15 = createFileRoute("/w/kiln")({
	component: lazyRouteComponent($$splitComponentImporter$15, "component"),
	head: () => pageMeta(`${BRAND$1} — Kiln`, `A volumetric field lit by one source that scroll walks across.`)
});
var $$splitComponentImporter$14 = () => import("./w.fold-BdnkFIOJ.mjs");
var Route$14 = createFileRoute("/w/fold")({
	component: lazyRouteComponent($$splitComponentImporter$14, "component"),
	head: () => pageMeta(`${BRAND$1} — Fold`, `A campaign photograph creased in a fragment program as the page scrolls.`)
});
var $$splitComponentImporter$13 = () => import("./w.drift-D7WXzIam.mjs");
var Route$13 = createFileRoute("/w/drift")({
	component: lazyRouteComponent($$splitComponentImporter$13, "component"),
	head: () => pageMeta(`${BRAND$1} — Drift`, `24 pieces under a live gradient field that answers to scroll.`)
});
var $$splitComponentImporter$12 = () => import("./w.corridor-CXV0vXa7.mjs");
var Route$12 = createFileRoute("/w/corridor")({
	component: lazyRouteComponent($$splitComponentImporter$12, "component"),
	head: () => pageMeta(`${BRAND$1} — Corridor`, `A scroll-driven flight through the making of the ${SEASON.toLowerCase()} edition.`)
});
var $$splitComponentImporter$11 = () => import("./w.cloth-CXewFY2I.mjs");
var Route$11 = createFileRoute("/w/cloth")({
	component: lazyRouteComponent($$splitComponentImporter$11, "component"),
	head: () => pageMeta(`${BRAND$1} — Cloth`, `A GLSL canvas that behaves like heavy fabric, driven by scroll position.`)
});
var $$splitComponentImporter$10 = () => import("./w.bloom-9tagzyFj.mjs");
var Route$10 = createFileRoute("/w/bloom")({
	component: lazyRouteComponent($$splitComponentImporter$10, "component"),
	head: () => pageMeta(`${BRAND$1} — Bloom`, `A twelve thousand point cloud that dissolves as you scroll.`)
});
var $$splitComponentImporter$9 = () => import("./w.atlas-BeDgX8gH.mjs");
var Route$9 = createFileRoute("/w/atlas")({
	component: lazyRouteComponent($$splitComponentImporter$9, "component"),
	head: () => pageMeta(`${BRAND$1} — Atlas`, `The whole edition as one wall, flown across by scroll.`)
});
var $$splitComponentImporter$8 = () => import("./s.v3-CJKJVQMB.mjs");
/** one replica per fit, in FITS order: euro, corner, rest */
var Route$8 = createFileRoute("/s/v3")({
	component: lazyRouteComponent($$splitComponentImporter$8, "component"),
	head: () => pageMeta(`${BRAND$2} — The Figure Shop (VRM)`, `${DROP} cast as three collectible figures. ${PIECES.length} pieces, worn by the set.`)
});
var $$splitComponentImporter$7 = () => import("./s.v2-1rBoch5U.mjs");
var Route$7 = createFileRoute("/s/v2")({
	component: lazyRouteComponent($$splitComponentImporter$7, "component"),
	head: () => pageMeta(`${BRAND$2} — The Figure Shop`, `${DROP} cast as three collectible figures. ${PIECES.length} pieces, worn by the set.`)
});
...
var NorthlineWorldRoute = Route$25.update({
	id: "/northline-world",
	path: "/northline-world",
	getParentRoute: () => Route$26
});
var NorthlineRoute = Route$24.update({
	id: "/northline",
	path: "/northline",
	getParentRoute: () => Route$26
});
var EditionsRoute = Route$23.update({
	id: "/editions",
	path: "/editions",
	getParentRoute: () => Route$26
});
...
var WIndexRoute = Route$21.update({
	id: "/w/",
	path: "/w/",
	getParentRoute: () => Route$26
});
var SIndexRoute = Route$20.update({
	id: "/s/",
	path: "/s/",
	getParentRoute: () => Route$26
});
var NlIndexRoute = Route$19.update({
	id: "/nl/",
	path: "/nl/",
	getParentRoute: () => Route$26
});
var WWeaveRoute = Route$18.update({
	id: "/w/weave",
	path: "/w/weave",
	getParentRoute: () => Route$26
});
var WVitrineRoute = Route$17.update({
	id: "/w/vitrine",
	path: "/w/vitrine",
	getParentRoute: () => Route$26
});
var WTideRoute = Route$16.update({
	id: "/w/tide",
	path: "/w/tide",
	getParentRoute: () => Route$26
});
var WKilnRoute = Route$15.update({
	id: "/w/kiln",
	path: "/w/kiln",
	getParentRoute: () => Route$26
});
var WFoldRoute = Route$14.update({
	id: "/w/fold",
	path: "/w/fold",
	getParentRoute: () => Route$26
});
var WDriftRoute = Route$13.update({
	id: "/w/drift",
	path: "/w/drift",
	getParentRoute: () => Route$26
});
var WCorridorRoute = Route$12.update({
	id: "/w/corridor",
	path: "/w/corridor",
	getParentRoute: () => Route$26
});
var WClothRoute = Route$11.update({
	id: "/w/cloth",
	path: "/w/cloth",
	getParentRoute: () => Route$26
});
var WBloomRoute = Route$10.update({
	id: "/w/bloom",
	path: "/w/bloom",
	getParentRoute: () => Route$26
});
var WAtlasRoute = Route$9.update({
	id: "/w/atlas",
	path: "/w/atlas",
	getParentRoute: () => Route$26
});
var SV3Route = Route$8.update({
	id: "/s/v3",
	path: "/s/v3",
	getParentRoute: () => Route$26
});
var SV2Route = Route$7.update({
	id: "/s/v2",
	path: "/s/v2",
	getParentRoute: () => Route$26
});
