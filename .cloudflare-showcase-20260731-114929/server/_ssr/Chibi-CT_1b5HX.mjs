...
//#region node_modules/.nitro/vite/services/ssr/assets/Chibi-CT_1b5HX.js
...
var GLB_CANDIDATES = OUTFITS.map((o) => o.model);
function ChibiHero({ fallbackSrc, vrmUrls, layout = "framed" }) {
	const [i, setI] = (0, import_react.useState)(0);
	const reduced = useReducedMotion();
	const outfit = OUTFITS[i];
	const next = () => setI((v) => (v + 1) % OUTFITS.length);
	(0, import_react.useEffect)(() => () => disposeFabrics(), []);
	const modelProbe = useModelAvailable((0, import_react.useMemo)(() => [
		VRM_URL,
		...vrmUrls ?? [],
		...GLB_CANDIDATES
	], [vrmUrls]));
	...
	const modelUrl = modelProbe.state === "ready" && !vrmBroken ? modelProbe.present.has("/fieldtrip/mascot.vrm") ? VRM_URL : replicaUrl && modelProbe.present.has(replicaUrl) ? replicaUrl : modelProbe.present.has(outfit.model) ? outfit.model : void 0 : void 0;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: layout === "stage" ? "relative h-[min(74vh,880px)] w-full" : "relative aspect-[3/4] w-full overflow-hidden",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Stage, {
				...
				antialias: true,
				shadows: true,
				fallback: reduced ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					src: fallbackSrc,
				...
				children: [
					...
					}) : modelProbe.state === "ready" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Figure, {
						outfit,
						onPick: next,
						still: reduced
					}) : null
				]
			}), layout === "framed" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
//#endregion
export { shot as n, shotFor as r, ChibiHero as t };
