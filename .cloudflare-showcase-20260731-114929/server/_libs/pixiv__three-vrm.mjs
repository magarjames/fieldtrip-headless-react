import { A as GLBufferAttribute, B as InterleavedBuffer, F as ImageLoader, Ft as Skeleton, Gt as Vector2, It as SkinnedMesh, J as LineBasicMaterial, K as Line, Kt as Vector3, Nt as ShaderMaterial, T as Euler, Tt as Quaternion, Ut as UniformsUtils, V as InterleavedBufferAttribute, X as LineSegments, _t as Object3D, at as Matrix3, ct as MeshBasicMaterial, f as BufferAttribute, i as UniformsLib, it as MathUtils, j as Group, l as AxesHelper, ot as Matrix4, p as BufferGeometry, rt as Material, st as Mesh, v as Color, w as DynamicDrawUsage } from "./@monogrid/gainmap-js+[...].mjs";
...
function reorganizeIndexAttribute(newGeometry, originalIndex, originalIndexNewIndexMap) {
	...
	for (let i = 0; i < originalIndexArray.length; i++) newIndexArray[i] = originalIndexNewIndexMap[originalIndexArray[i]];
...
*/
//#endregion
export { VRMUtils as n, VRMLoaderPlugin as t };
