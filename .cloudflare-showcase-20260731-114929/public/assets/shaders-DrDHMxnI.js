...
`,c={void:[.02,.02,.02],ink:[.96,.95,.93],rust:[.71,.33,.23],olive:[.42,.42,.29],stone:[.66,.63,.59],smoke:[.36,.42,.47],band:[.04,.04,.04]};export{i as a,a as c,c as i,t as n,s as o,r,o as s,n as t};